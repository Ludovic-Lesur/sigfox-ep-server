...
METEOFOX_TEST_REQUEST = [
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "5436", "1406050075753760", SIGFOX_CALLBACK_JSON_FALSE],
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "5436", "1456030026c804185707", SIGFOX_CALLBACK_JSON_FALSE],
    # MeteoFox geoloc timeout data V1.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "53b5", "78", SIGFOX_CALLBACK_JSON_FALSE],
    # MeteoFox geoloc timeout data V2.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "53b5", "210e40", SIGFOX_CALLBACK_JSON_FALSE],
...
TRACKFOX_TEST_REQUEST = [
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "4257", "163b12a5094f74", SIGFOX_CALLBACK_JSON_FALSE],
    # TrackFox monitoring data with error.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "4257", "16ff0007094e7c", SIGFOX_CALLBACK_JSON_FALSE],
