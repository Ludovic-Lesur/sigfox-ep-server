...
DATABASE_FIELD_GEOLOCATION_RADIUS = "geolocation_radius"
DATABASE_FIELD_GEOLOCATION_RADIUS_GPS = 10
DATABASE_FIELD_GEOLOCATION_SOURCE = "geolocation_source"
DATABASE_FIELD_GEOLOCATION_SOURCE_GPS = 0
DATABASE_FIELD_GEOLOCATION_SOURCE_SIGFOX_ATLAS_WIFI = 1
