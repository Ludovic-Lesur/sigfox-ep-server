...
TRACKFOX_TEST_REQUEST = [
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_ADVANCED, "4257", str(SIGFOX_CALLBACK_GEOLOCATION_SOURCE_NETWORK), 1],
    [SIGFOX_CALLBACK_TYPE_DATA_ADVANCED, "4257", str(SIGFOX_CALLBACK_GEOLOCATION_SOURCE_NETWORK), 2],
    # TrackFox Sigfox Atlas WiFi callback.
    [SIGFOX_CALLBACK_TYPE_DATA_ADVANCED, "4257", str(SIGFOX_CALLBACK_GEOLOCATION_SOURCE_WIFI), 1],
    ...
    def make(log_message: str, request_table: List[str]) -> None:
        ...
        for idx in range(len(request_table)):
            ...
            if (callback_type == SIGFOX_CALLBACK_TYPE_DATA_UPLINK):
                ...
                json_from_backend[SIGFOX_CALLBACK_JSON_KEY_GEOLOCATION][SIGFOX_CALLBACK_JSON_KEY_GEOLOCATION_STATUS] = int(request_table[idx][3])
