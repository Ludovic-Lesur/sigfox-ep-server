...
DINFOX_TEST_REQUEST = [
    ...
    # TrackFox invalid Sigfox EP-ID.
    {SFXS_BACKEND_JSON_HEADER_TIME : "1666374408", SFXS_BACKEND_JSON_HEADER_EP_ID : "aabb", SFXS_BACKEND_JSON_HEADER_DATA : "20000bb91a"},
    # TrackFox invalid data.
    {SFXS_BACKEND_JSON_HEADER_TIME : "1666374409", SFXS_BACKEND_JSON_HEADER_EP_ID : "4761", SFXS_BACKEND_JSON_HEADER_DATA : "2000"},
]
