...
METEOFOX_TEST_REQUEST = [
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374002", "5436", "1", "1406050075753760", JSON_FALSE],
    # MeteoFox monitoring data without error.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374003", "53b5", "2", "10173d3d4ca45d387e", JSON_FALSE],
    # MeteoFox monitoring data with error.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374004", "53b5", "3", "117f401830a43d593f", JSON_FALSE],
    # MeteoFox geoloc data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374005", "53b5", "4", "2b81e249017a1cbf00a653", JSON_FALSE],
    # MeteoFox IM weather data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374006", "53b5", "5", "183a03002726", JSON_FALSE],
    # MeteoFox CM weather data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374007", "53b5", "6", "1456030026c804185707", JSON_FALSE],
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374008", "5436", "6", "1456030026c804185707", JSON_FALSE],
    # MeteoFox geoloc timeout data V1.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374009", "53b5", "7", "78", JSON_FALSE],
    # MeteoFox geoloc timeout data V2.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374010", "53b5", "8", "210e40", JSON_FALSE],
    # MeteoFox geoloc timeout data V3.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374011", "53b5", "9", "0178", JSON_FALSE],
    # MeteoFox error stack data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374012", "53b5", "10", "270d00000000000000000000", JSON_FALSE],
    # MeteoFox invalid Sigfox EP-ID.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374013", "0123", "11", "050c3900f29d1d2f7f", JSON_FALSE],
    # MeteoFox invalid data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374014", "53b5", "12", "01020304", JSON_FALSE]
]

SENSIT_TEST_REQUEST = [
    # Sensit monitoring data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374100", "86bd75", "100", "ae096e97", JSON_FALSE],
    # Sensit configuration data
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374101", "86bd75", "101", "b609759846003f0f8004223c", JSON_TRUE],
    # Sensit invalid data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374102", "86bd75", "102", "010203", JSON_FALSE],
    # Sensit invalid Sigfox EP-ID.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374103", "0123", "103", "050c3900f29d", JSON_FALSE]
]
...
ATXFOX_TEST_REQUEST = [
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374209", "abcd", "207", "050c3900f29d1d2f7f", JSON_FALSE],
    # ATXFox invalid data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374210", "868e", "208", "010203", JSON_FALSE]
]
...
DINFOX_TEST_REQUEST = [
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374401", "4761", "401", "20000bb90104", JSON_FALSE],
    # DINFox LVRM monitoring payload with error.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374402", "4761", "402", "2000ffff0104", JSON_FALSE],
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374404", "4761", "404", "02010bbd0918", JSON_FALSE],
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374408", "47a7", "408", "29020bb90118", JSON_FALSE],
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374410", "4761", "410", "03030bb600e60b480bb700", JSON_FALSE],
    # DINFox GPSM monitoring payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374411", "4761", "411", "04040bb800fa0bb00bb700", JSON_FALSE],
    # DINFox SM monitoring payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374412", "4761", "412", "05050bb20110", JSON_FALSE],
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374414", "4761", "414", "050500cf33", JSON_FALSE],
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374416", "4761", "416", "0008200f2010201120122013", JSON_FALSE],
    # DINFox R4S8CR electrical payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374421", "479c", "417", "700ac981", JSON_FALSE],
    # DINFox invalid Sigfox EP-ID.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374422", "aabb", "418", "20000bb91a", JSON_FALSE],
    # DINFox invalid data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374423", "4761", "419", "2000", JSON_FALSE],
    # DINFox MPMCM status payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374424", "47ea", "420", "060929", JSON_FALSE],
    # DINFox MPMCM electrical mains voltage payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374425", "47ea", "421", "060904892d892f893b", JSON_FALSE],
    # DINFox MPMCM electrical mains frequency payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374426", "47ea", "422", "0609138213841393", JSON_FALSE],
    # DINFox MPMCM electrical mains power payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374427", "47ea", "423", "060900072c08c00b050dd8", JSON_FALSE],
    # DINFox MPMCM electrical mains power factor payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374428", "47ea", "424", "060903c2c2cf", JSON_FALSE],
    # DINFox MPMCM electrical mains energy payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374429", "47ea", "425", "0609031c231c41", JSON_FALSE],
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374430", "47ea", "426", "06090203330444", JSON_FALSE],
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374431", "47ea", "427", "0609041c001b00", JSON_FALSE],
    # DINFox BCM monitoring payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374432", "47ea", "428", "070b0bb21c", JSON_FALSE],
    # DINFox BCM electrical payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374433", "47ea", "429", "070b051232ba19b8137d0a", JSON_FALSE]
]
