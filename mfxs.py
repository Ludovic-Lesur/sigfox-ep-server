...
INFLUXDB_LATITUDE = "latitude"
INFLUXDB_NORTH = "north"
INFLUXDB_LONGITUDE = "longitude"
INFLUXDB_EAST = "east"
INFLUXDB_ALTITUDE = "altitude"
INFLUXDB_GPS_FIX_DURATION = "gps_fix_duration"
INFLUXDB_COM_STATUS = "com_status"
...
def index():
    ...
    return 'SPSWS server running.'
    
@app.route("/<device_id>/<data>")
def action(device_id, data):
