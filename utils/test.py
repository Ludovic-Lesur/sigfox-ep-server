...
METEOFOX_TEST_REQUEST = [
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "53b5", "1456030026c804185707", SIGFOX_CALLBACK_JSON_TRUE],
...
TRACKFOX_TEST_REQUEST = [
    ...
    # TrackFox geoloc error data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "4257", "011e030a", SIGFOX_CALLBACK_JSON_FALSE],
    # TrackFox error stack data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "4257", "1f020000000000000000", SIGFOX_CALLBACK_JSON_FALSE],
    # TrackFox Sigfox Atlas Native callback.
    [SIGFOX_CALLBACK_TYPE_DATA_ADVANCED, "4257", "60627800", str(SIGFOX_CALLBACK_GEOLOCATION_SOURCE_NETWORK), 1],
    [SIGFOX_CALLBACK_TYPE_DATA_ADVANCED, "4257", "6c7220d7979c8082fe395b00", str(SIGFOX_CALLBACK_GEOLOCATION_SOURCE_NETWORK), 2],
    [SIGFOX_CALLBACK_TYPE_DATA_ADVANCED, "4257", "6f7220d7979c8082fe395b00", str(SIGFOX_CALLBACK_GEOLOCATION_SOURCE_NETWORK), 2],
    # TrackFox Sigfox Atlas WiFi callback.
    [SIGFOX_CALLBACK_TYPE_DATA_ADVANCED, "4257", "c0d7aa5da0e4000000000000", str(SIGFOX_CALLBACK_GEOLOCATION_SOURCE_WIFI), 1],
     # TrackFox invalid data.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "4257", "010203", SIGFOX_CALLBACK_JSON_FALSE],
    ...
    def make(log_message: str, request_table: List[str]) -> None:
        ...
        for idx in range(len(request_table)):
            ...
            if (callback_type == SIGFOX_CALLBACK_TYPE_DATA_UPLINK):
                ...
                json_from_backend[SIGFOX_CALLBACK_JSON_KEY_GEOLOCATION][SIGFOX_CALLBACK_JSON_KEY_GEOLOCATION_SOURCE] = int(request_table[idx][3])
                json_from_backend[SIGFOX_CALLBACK_JSON_KEY_GEOLOCATION][SIGFOX_CALLBACK_JSON_KEY_GEOLOCATION_STATUS] = int(request_table[idx][4])
