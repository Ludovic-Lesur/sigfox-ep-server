...
TRACKFOX_TEST_REQUEST = [
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374307", "4257", "307", "01020304", JSON_FALSE]
]
...
DINFOX_TEST_REQUEST = [
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374408", "47a7", "408", "31020bb91c", JSON_FALSE],
    # DINFox DDRM electrical payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374409", "47a7", "409", "310200000b04000000", JSON_FALSE],
    # DINFox UHFM monitoring payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374410", "4761", "410", "0c030bb6170b480bb7", JSON_FALSE],
    # DINFox GPSM monitoring payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374411", "4761", "411", "10040bb8190bb00bb7", JSON_FALSE],
    # DINFox SM monitoring payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374412", "4761", "412", "14050bb21c", JSON_FALSE],
    # DINFox SM electrical payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374413", "4761", "413", "14050123ffff023404560b", JSON_FALSE],
    # DINFox SM sensor payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374414", "4761", "414", "14051433", JSON_FALSE],
    ...
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374420", "47ea", "421", "1c0929", JSON_FALSE],
    # DINFox MPMCM electrical mains voltage payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374420", "47ea", "422", "1c0904892d892f893b", JSON_FALSE],
    # DINFox MPMCM electrical mains frequency payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374421", "47ea", "423", "1c09138213841393", JSON_FALSE],
    # DINFox MPMCM electrical mains power payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374422", "47ea", "424", "1c0900072c08c00b050dd8", JSON_FALSE],
    # DINFox MPMCM electrical mains power factor payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374423", "47ea", "425", "1c0903c2c2cf", JSON_FALSE],
    # DINFox MPMCM electrical mains energy payload.
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374424", "47ea", "426", "1c09031c231c41", JSON_FALSE],
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374425", "47ea", "427", "1c090203330444", JSON_FALSE],
    [SIGFOX_CALLBACK_TYPE_DATA_BIDIR, "1666374426", "47ea", "428", "1c09041c001b00", JSON_FALSE]
]
